...
# Originally published in https://github.com/chaotic-cx/nyx/commits/main/modules/nixos/zfs-impermanence-on-shutdown.nix
{ config
, lib
, pkgs
, ...
...
let
  cfg = config.pedrohlc.zfs-impermanence-on-shutdown;
