...
let
  config = {
    ...
    "authorized_fingerprints" = {
      ...
      "8c:bd:ff:d3:d4:45:68:7e:f2:9a:dd:5b:7b:e6:39:e2:75:59:f4:b9:a5:44:e6:28:17:e1:a3:da:3d:19:ed:50" = "xbox";
    };
  };
...
mkIf (kvm != null) {
  ...
  launchd.agents.my-kvm = mkIf hasAppleSeat {
    ...
    config = {
      ...
      ProgramArguments = [ "${pkgs.lan-mouse}/bin/lan-mouse" "-d" "-c" (toString configFile) ];
      RunAtLoad = true;
      KeepAlive = true;
    };
  };
