    ...
    settings =
      let
        ...
        goodGuys = [
          ...
          { name = "Vivo"; ids = [ "152.240.0.0/12" "177.68.0.0/16" "177.24.0.0/14" "187.88.0.0/14" "177.76.0.0/14" "177.102.0.0/15" "189.96.0.0/15" "189.98.0.0/15" "200.176.3.0/24" "200.148.0.0/17" "2804:18::/32" "2804:7efc::/32" "2804:431:c000::/37" ]; tags = [ "user_regular" ]; }
